                    ...
                    <div>
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <form action="<?=base_url();?>backoffice/withdraw/cs_process" method="post">
...
$(document).ready(function() {
  ...
  var table = $('#table').DataTable( {
    ...
    "columns": [
        ...
        { "data": "order_id" },
        {
          "data": "total_commision_cs",
          "render": function(data, type, row) {
            if ( type === "sort" || type === 'type' ) {
              return data
            } else {
              return currency(row.total_commision_cs)
            }
          }
        },
        { "data": "created_at" },
  ...
  let urlHistory = BASE_URL + 'backoffice/withdraw/cs_history'
